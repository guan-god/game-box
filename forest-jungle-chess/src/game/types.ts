export type Side='red'|'blue';export type PieceType='elephant'|'lion'|'tiger'|'leopard'|'wolf'|'dog'|'cat'|'rat';export type CellType='land'|'river'|'trap_red'|'trap_blue'|'den_red'|'den_blue';
...
export type GameState={turn:Side;winner?:Side|'draw';moves:Move[];captured:{red:Piece[];blue:Piece[]};noCapture:number;mode:GameMode;ai:AIDifficulty;config:RuleConfig};
