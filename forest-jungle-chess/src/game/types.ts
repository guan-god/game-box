...
export type GameState={turn:Side;winner?:Side|'draw';moves:Move[];captured:{red:Piece[];blue:Piece[]};noCapture:number;mode:GameMode;ai:AIDifficulty;config:RuleConfig;extraTurn?:Side};
